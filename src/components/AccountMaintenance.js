  ...
  return (
    <div className='mt-8'>
      ...
      <div className='flex bg-gray-100 bg-white shadow-md p-6 rounded-lg'>
        ...
        <div className='w-4/5'>
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>{sections[currentSection].fields.map((fieldName) => (accountDetails.hasOwnProperty(fieldName) ? renderField(fieldName) : null))}</div>
