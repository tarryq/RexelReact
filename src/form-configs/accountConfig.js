...
export const accountConfig = {
    eclipseEntityID: { label: 'Eclipse ID', type: 'text', readOnly: false },
    eclipseUserName: { label: 'Eclipse Username', type: 'text', readOnly: false },
 eclipsePassword: { label: 'Eclipse Password', type: 'password' },
 name: { label: 'Account Name', type: 'text', readOnly: true },
 simpleName: { label: 'Account Simple Name', type: 'text', readOnly: false },
 fmsCustomerID: { label: 'FMS Customer ID (optional)', type: 'text', readOnly: false },
 address1: { label: 'Address Line 1', type: 'text' },
 address2: { label: 'Address Line 2', type: 'text' },
 city: { label: 'City', type: 'text', readOnly: true },
 region: { label: 'State/Region', type: 'text', readOnly: true },
 zipCode: { label: 'Zip Code', type: 'text', readOnly: true },
 country: { label: 'Country', type: 'text', readOnly: true },
 contactname: { label: 'Account Contact Name', type: 'text' },
 telephone: { label: 'Account Contact Telephone', type: 'text' },
 fax: { label: 'Account Contact Fax', type: 'text' },
 eMail: { label: 'Account Contact Email', type: 'text' },
 formalCompanyName: { label: 'Formal Company Name', type: 'text', readOnly: true },
 orderMultiplier: { label: 'Whole Order Multiplier', type: 'number' },
 defaultShippingMethodID: {
  label: 'Default Shipping Method',
  type: 'select',
  options: ['UPS GROUND', 'FedEx', 'USPS']
 },
 serviceProviderID: { label: 'Service Provider', type: 'text' },
